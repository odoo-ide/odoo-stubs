...
from typing import Any, Optional, List, Dict, Generator, OrderedDict, TypeVar
...
class BaseModel(MetaModel('DummyModel', (object,), {'_register': False})):
    ...
    def read(self, fields: Optional[list[str]] = ..., load: str = ...): ...
    ...
    def _create(self, data_list: list[dict[str, Any]]): ...
    ...
    def browse(self: _M, ids: Optional[Any] = ...) -> _M: ...
    @property
    ...
    def with_user(self: _M, user: Any) -> _M: ...
    def with_company(self: _M, company: Any) -> _M: ...
    def with_context(self: _M, *args: Any, **kwargs: Any) -> _M: ...
    def with_prefetch(self: _M, prefetch_ids: Optional[Any] = ...) -> _M: ...
