...
def add_constraint(cr: Cursor, tablename: str, constraintname: str, definition) -> None: ...
...
def create_index(cr: Cursor, indexname: str, tablename: str, expressions) -> None: ...
def create_unique_index(cr: Cursor, indexname: str, tablename: str, expressions) -> None: ...
def drop_index(cr: Cursor, indexname: str, tablename: str) -> None: ...
def drop_view_if_exists(cr: Cursor, viewname) -> None: ...
